...
class EVENTS:
	...
	const PLAY_PLAYERFINALABSORBWIN_V1 = 3940632246
	...
	const PLAY_BURNERLOOP_V2 = 1540338041
	const PLAY_KNOCKBACKGUY_ATTACK = 1578105619
	const PLAY_MUSIC_V2 = 387490322
	const PLAY_KNOCKBACKGUY_DAMAGE = 121161684
	...
	const _dict = {
		...
		"Play_PlayerFinalAbsorbWin_V1": PLAY_PLAYERFINALABSORBWIN_V1,
		...
		"Play_BurnerLoop_V2": PLAY_BURNERLOOP_V2,
		"Play_KnockbackGuy_Attack": PLAY_KNOCKBACKGUY_ATTACK,
		"Play_Music_V2": PLAY_MUSIC_V2,
		"Play_KnockbackGuy_Damage": PLAY_KNOCKBACKGUY_DAMAGE,
